...
int main(void) {
    const char* const test_domains[] = {
        "www.example.com", "a.b.c", "www.bupt.edu.cn",
        "sub-domain.example.co.uk",
        /* 连字符开头 */
        "-invalid.com", "www.-invalid.com",
        /* 连字符结尾 */
        "invalid-.com", "www.invalid-.com",
        /* 二连点号 */
        "invalid..com",
        ...
        "23456789abcdef0123456789abcdef0123456789abcdef.com",
        /* 非法字符 */
        "www.&.com"};

    const bool test_domains_results[] = {true,  true,  true,  true,

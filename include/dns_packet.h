...
#define DNS_FLAGS_QR_BIT_SIZE \
    (DNS_FLAGS_OPCODE_BIT_INDEX - DNS_FLAGS_QR_BIT_INDEX)
#define DNS_FLAGS_OPCODE_BIT_SIZE \
    (DNS_FLAGS_AA_BIT_INDEX - DNS_FLAGS_OPCODE_BIT_INDEX)
...
#define DNS_FLAGS_RCODE_BIT_SIZE \
    (DNS_FLAGS_BIT_SIZE - DNS_FLAGS_RCODE_BIT_INDEX)

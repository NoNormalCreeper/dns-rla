...
/* Header 各部分的偏移值 */
#define DNS_ID_INDEX 0
#define DNS_FLAGS_INDEX 2
#define DNS_QDCOUNT_INDEX 4
#define DNS_ANCOUNT_INDEX 6
#define DNS_NSCOUNT_INDEX 8
#define DNS_ARCOUNT_INDEX 10

/* Header 各部分都是 2 字节的，使用 u16 */
#define DNS_HEADER_PART_SIZE 2

/* flags 一共是 16 位*/
#define DNS_FLAGS_BIT_SIZE 16

/* Header 中 flags 里各部分的位偏移值 */
#define DNS_FLAGS_QR_BIT_INDEX 0
#define DNS_FLAGS_OPCODE_BIT_INDEX 1
#define DNS_FLAGS_AA_BIT_INDEX 5
#define DNS_FLAGS_TC_BIT_INDEX 6
#define DNS_FLAGS_RD_BIT_INDEX 7
#define DNS_FLAGS_RA_BIT_INDEX 8
#define DNS_FLAGS_Z_BIT_INDEX 9
#define DNS_FLAGS_RCODE_BIT_INDEX 12

/* Header 中 flags 里各部分的位个数 */
#define DNS_FLAGS_QR_BIT_SIZE (DNS_FLAGS_OPCODE_BIT_INDEX - DNS_FLAGS_QR_BIT_INDEX)
#define DNS_FLAGS_OPCODE_BIT_SIZE (DNS_FLAGS_AA_BIT_INDEX - DNS_FLAGS_OPCODE_BIT_INDEX)
#define DNS_FLAGS_AA_BIT_SIZE (DNS_FLAGS_TC_BIT_INDEX - DNS_FLAGS_AA_BIT_INDEX)
#define DNS_FLAGS_TC_BIT_SIZE (DNS_FLAGS_RD_BIT_INDEX - DNS_FLAGS_TC_BIT_INDEX)
#define DNS_FLAGS_RD_BIT_SIZE (DNS_FLAGS_RA_BIT_INDEX - DNS_FLAGS_RD_BIT_INDEX)
#define DNS_FLAGS_RA_BIT_SIZE (DNS_FLAGS_Z_BIT_INDEX - DNS_FLAGS_RA_BIT_INDEX)
#define DNS_FLAGS_Z_BIT_SIZE (DNS_FLAGS_RCODE_BIT_INDEX - DNS_FLAGS_Z_BIT_INDEX)
#define DNS_FLAGS_RCODE_BIT_SIZE (DNS_FLAGS_BIT_SIZE - DNS_FLAGS_RCODE_BIT_INDEX)
